...
export default function PeriodOperationsPage() {
  const modules = [
    {
      title: 'Period Close',
      description: 'Month-end and quarter-end closing procedures and checklists',
      href: '/finance/period-operations/period-close',
      icon: Calendar,
      color: 'blue',
    },
    {
      title: 'Year-End Close',
      description: 'Annual closing procedures and year-end adjustments',
      href: '/finance/period-operations/year-end',
      icon: CalendarCheck,
      color: 'purple',
    },
  ];
