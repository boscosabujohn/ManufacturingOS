    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Project Handover Management</h1>
            <p className="text-gray-600 mt-1">Track sales to operations handover process</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-yellow-100 text-sm font-medium">Pending Handovers</p>
                <p className="text-3xl font-bold mt-2">{stats.pendingHandovers}</p>
                <p className="text-yellow-100 text-xs mt-1">Awaiting acceptance</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-green-100 text-xs mt-1">Successful handovers</p>
              </div>
              <div className="bg-white/20 p-3 rounded-lg">
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100 text-xs mt-1">Active handovers</p>
              </div>
              <div className="bg-white/20 p-3 rounded-lg">
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-100 text-sm font-medium">Acceptance Rate</p>
