...
export default function CreateQuotationPage() {
  const [quotationNumber, setQuotationNumber] = useState('QUO-' + new Date().getFullYear() + '-' + Math.floor(Math.random() * 10000).toString().padStart(4, '0'));
  ...
  const customers: Customer[] = [
    ...
    },
    {
      ...
      address: '789 Export Zone, Noida, Uttar Pradesh 201301'
    },
    {
      id: 'CUST-004',
      name: 'Sneha Patel',
      ...
      address: '321 Industrial Estate, Ahmedabad, Gujarat 380015'
    }
  ];
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600 mt-1">{selectedCustomer.address}</p>
                      </div>
                    </div>
                    <button
