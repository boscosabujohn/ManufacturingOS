        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className={`sticky top-0 px-6 py-4 flex items-center justify-between ${
              selectedTicket.priority === 'P1' ? 'bg-gradient-to-r from-red-600 to-orange-600' :
            ...
            <div className="p-6 space-y-6">
              ...
              <div className={`rounded-lg p-4 border-2 ${
                selectedTicket.priority === 'P1' ? 'bg-red-50 border-red-200' :
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <AlertCircle className={`h-8 w-8 ${
                      selectedTicket.priority === 'P1' ? 'text-red-600' :
                      selectedTicket.priority === 'P2' ? 'text-orange-600' :
                      'text-yellow-600'
                    }`} />
                    <div>
                      <h3 className={`text-lg font-bold ${
                        selectedTicket.priority === 'P1' ? 'text-red-900' :
                      ...
                      <p className={`text-sm ${
                        selectedTicket.priority === 'P1' ? 'text-red-700' :
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`text-sm font-semibold ${
                      selectedTicket.priority === 'P1' ? 'text-red-600' : 'text-orange-600'
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className={`rounded-lg p-5 border-2 ${
                stats.slaCompliance >= 90 ? 'bg-green-50 border-green-200' :
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className={`text-xl font-bold ${
                        stats.slaCompliance >= 90 ? 'text-green-900' :
                      ...
                      <p className={`text-sm ${
                        stats.slaCompliance >= 90 ? 'text-green-700' :
