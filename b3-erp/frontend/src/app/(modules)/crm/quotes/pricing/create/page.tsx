    ...
    <div className="w-full h-full px-3 py-2 ">
      <div className="">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Create Pricing Rule</h1>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700">
                      Rules with lower priority numbers are evaluated first. Make sure conditions are specific enough to avoid conflicts.
                    </p>
                  </div>
                </div>
              </div>
