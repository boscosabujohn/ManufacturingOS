...
export default function DocumentsPage() {
  ...
  const mockDocuments: Document[] = [
    ...
    {
      id: 'DOC-CONF-001',
      documentNumber: 'CONF-2026-001',
      projectId: 'PRJ-2026-001',
      projectName: 'Industrial Kitchen 2026',
      documentName: 'Project Award Confirmation Letter',
      ...
      expiryDate: '',
      tags: ['Confirmation', 'Award', 'Handover', 'Phase 1'],
      description: 'Official confirmation letter for the Industrial Kitchen 2026 project awarding.',
      relatedDocuments: [],
    },
  ];
