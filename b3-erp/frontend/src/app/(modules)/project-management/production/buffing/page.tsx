    ...
    return (
      <div className="w-full py-2 space-y-6 px-3">
        <div className="flex items-center gap-2 mb-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Select Project for Buffing</h1>
            <p className="text-sm text-gray-500 font-medium">Step 5.5: Manage surface finishing and buffing operations</p>
          </div>
        </div>
    ...
    <div className="w-full py-2 space-y-4 px-3 font-sans">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={() => router.push('/project-management/production/shutter-work')} size="sm">
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20">
          <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-primary"></div>
          <p className="mt-4 text-gray-500 font-medium">Loading buffing jobs...</p>
        </div>
      ) : (
        <Card className="border-none shadow-sm ring-1 ring-gray-200 overflow-hidden">
          <CardHeader className="bg-gray-50/50 border-b py-4">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-lg font-bold tracking-tight">Buffing Job Queue</CardTitle>
            </div>
          </CardHeader>
            ...
            <table className="w-full text-sm text-left">
              <thead className="bg-gray-50/30 text-[10px] font-bold uppercase tracking-widest text-gray-500">
                <tr>
                  ...
                  <th className="p-4">Finish Type</th>
                  <th className="p-4">Qty</th>
                  <th className="p-4">Surface Check</th>
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          id={`qc-${job.id}`}
                        />
                        <label htmlFor={`qc-${job.id}`} className={`text-xs font-bold ${job.surfaceCheck ? 'text-green-600' : 'text-gray-500'}`}>
