                    ...
                    <table className="w-full">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {filteredProjects.map((project) => (
                                ...
                                >
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">{project.name}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{project.manager}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-900">${(project.budget / 1000).toFixed(0)}K</td>
