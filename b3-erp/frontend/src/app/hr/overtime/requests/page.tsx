  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Submit and manage overtime work requests</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
          ...
          <p className="text-2xl font-bold text-purple-900 mt-1">68</p>
        </div>
      </div>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {[...Array(10)].map((_, i) => (
              <tr key={i} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">OT{1000 + i}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Oct {15 + i}, 2025</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{2 + (i % 3)} hours</td>
