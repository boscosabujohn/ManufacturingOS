  ...
  const mockDocuments: EducationDocument[] = [
    {
      ...
      yearOfPassing: 2019,
      percentage: 8.5,
      certificateNumber: 'MBA/2019/1234',
    ...
    },
    {
      ...
      yearOfPassing: 2015,
      percentage: 75.5,
      certificateNumber: 'BCOM/2015/5678',
      uploadedOn: '2024-01-10',
      status: 'verified',
      fileSize: '389 KB',
    ...
    },
    {
      ...
      yearOfPassing: 2012,
      percentage: 82.0,
      certificateNumber: 'HSC/2012/9876',
      uploadedOn: '2024-01-10',
      status: 'verified',
      fileSize: '312 KB',
    ...
    },
    {
      ...
      yearOfPassing: 2010,
      percentage: 88.5,
      certificateNumber: 'SSC/2010/5432',
      uploadedOn: '2024-01-10',
      status: 'verified',
      fileSize: '298 KB',
      fileName: 'ssc_marksheet.pdf',
      verifiedBy: 'Kavita Sharma',
      verifiedOn: '2024-01-11'
    },
    {
      ...
      degree: 'CFA Level II',
      specialization: 'Chartered Financial Analyst',
      institution: 'CFA Institute',
      university: 'CFA Institute',
      yearOfPassing: 2020,
      percentage: 0,
      certificateNumber: 'CFA-L2-2020-12345',
      uploadedOn: '2024-01-15',
      status: 'pending',
      fileSize: '245 KB',
      fileName: 'cfa_level2_certificate.pdf'
    }
  ];
          ...
          return (
            <div key={doc.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="flex gap-2 pt-4 border-t border-gray-200">
                <button className="flex items-center gap-2 px-4 py-2 text-purple-600 hover:bg-purple-50 rounded-lg font-medium text-sm">
