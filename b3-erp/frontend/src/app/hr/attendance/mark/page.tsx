...
export default function MarkAttendancePage() {
  ...
  return (
    <div className="p-6">
      ...
      {/* Current Status Card */}
      <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-sm border border-blue-200 p-3 mb-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        {/* Location & Details */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Attendance Details</h3>
          <div className="space-y-2">
      ...
      <div className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-3">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Today's Attendance Log</h3>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {todayLog.map((log, idx) => (
                <tr key={idx} className="hover:bg-gray-50">
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">{log.time}</td>
                  ...
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-600">{log.location}</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-600">{log.device}</td>
                </tr>
              ))}
            </tbody>
          </table>
