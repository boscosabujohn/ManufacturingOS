      ...
      <div className="space-y-4">
        {filteredReturns.length > 0 ? (
          filteredReturns.map((esiReturn) => {
            ...
            return (
              <div key={esiReturn.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="bg-pink-50 rounded-lg p-3 border border-pink-200 mb-4">
