  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="p-6">
          <p className="text-gray-600 mb-2">Create a copy of "{template.templateName}"</p>
          <div>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="p-6">
          <p className="text-gray-600 mb-2">Export "{template.templateName}" to file</p>
          <div>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="p-6">
          <p className="text-gray-600 mb-2">Import a milestone template from file</p>
