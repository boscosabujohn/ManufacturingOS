...
export default function FreightCostAnalytics() {
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-gray-50 via-cyan-50 to-blue-50 p-3">
      <div className="">
        <div className="mb-3">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-3">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Cost Breakdown</h2>

          <div className="space-y-2">
            {costBreakdown.map((item) => (
              <div key={item.category} className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-3 border border-blue-200">
