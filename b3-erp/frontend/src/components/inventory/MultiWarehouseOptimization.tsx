      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {warehouses.map((wh) => {
            ...
            return (
              <div key={wh.id} className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Transfer Recommendations</h2>
