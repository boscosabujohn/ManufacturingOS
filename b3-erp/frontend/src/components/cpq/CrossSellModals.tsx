      ...
      <div className="bg-white rounded-lg shadow-xl w-full  max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-3">
          ...
          <div className="border border-gray-200 rounded-lg p-3">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Product Pairing Details</h3>
          ...
          {/* Performance Trend */}
          <div className="border border-gray-200 rounded-lg p-3">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">6-Month Performance Trend</h3>
          ...
          {/* Top Customers */}
          <div className="border border-gray-200 rounded-lg p-3">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Top Customers for This Pairing</h3>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-3">
          ...
          {opportunity && (
            <div className="bg-gradient-to-br from-green-50 to-emerald-100 border border-green-200 rounded-lg p-3">
              <h4 className="font-semibold text-gray-900 mb-2">Estimated Campaign Performance</h4>
