      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredDiscounts.map(discount => (
            <div key={discount.id} className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="mb-4">
                {discount.discountType === 'percentage' && (
                  <div className="flex items-center justify-center bg-orange-50 rounded-lg p-4 border-2 border-orange-200">
                ...
                {discount.discountType === 'fixed' && (
                  <div className="flex items-center justify-center bg-green-50 rounded-lg p-4 border-2 border-green-200">
                ...
                {discount.discountType === 'buy-x-get-y' && discount.buyXGetY && (
                  <div className="flex items-center justify-center bg-purple-50 rounded-lg p-4 border-2 border-purple-200">
