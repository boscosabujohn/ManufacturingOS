      ...
      <div className="bg-white shadow-lg border border-gray-200 rounded-lg p-3">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-lg border-2 border-dashed border-blue-300">
          <div className="text-center">
            <BarChart3 className="h-16 w-16 text-blue-600 mb-2" />
            <h4 className="text-xl font-bold text-gray-900 mb-2">Drag & Drop Report Builder</h4>
            <p className="text-gray-600 mb-2">Create custom reports with no SQL required - just drag dimensions and measures</p>
            <div className="flex justify-center gap-2">
              <button className="px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Start Building</button>
              <button className="px-3 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">Use Template</button>
            </div>
          </div>
        </div>
      </div>
