...
export enum WorkflowEventType {
  ...
  CONTRACT_SUBMITTED_FOR_APPROVAL = 'contract.submitted_for_approval',
  CONTRACT_APPROVED = 'contract.approved',
  CONTRACT_TERMINATED = 'contract.terminated',
  CONTRACT_RENEWED = 'contract.renewed',
  CONTRACT_PRICE_REVISED = 'contract.price_revised',
  CONTRACT_EXPIRING_SOON = 'contract.expiring_soon',
  JOB_REQUISITION_CREATED = 'job_requisition.created',
  JOB_REQUISITION_APPROVED = 'job_requisition.approved',
  ...
  ORDER_CREATED_FROM_RFP = 'order.created_from_rfp',
  ORDER_APPROVED = 'order.approved',
  ORDER_REJECTED = 'order.rejected',
  ORDER_APPROVAL_LEVEL_COMPLETED = 'order.approval_level_completed',
  HANDOVER_PACKAGE_CREATED = 'order.handover_package_created',
  ORDER_HANDOVER_ACCEPTED = 'order.handover_accepted',
  ...
  PRODUCTION_REQUEST_VALIDATED = 'production_request.validated',
  PRODUCTION_REQUEST_VALIDATION_FAILED = 'production_request.validation_failed',
  PRODUCTION_REQUEST_APPROVED = 'production_request.approved',
  ...
  INVOICE_MATCHING_VARIANCE = 'invoice.matching_variance',
  ...
  APPROVAL_ROUTED = 'approval.routed',
  APPROVAL_LEVEL_APPROVED = 'approval.level_approved',
  APPROVAL_ESCALATED = 'approval.escalated',
  APPROVAL_SLA_BREACHED = 'approval.sla_breached',
